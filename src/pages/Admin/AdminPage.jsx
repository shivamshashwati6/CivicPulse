...
import { ShieldAlert, Users, Filter, BarChart3, AlertOctagon } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <Card className="bg-gray-900 text-white border-0">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Unassigned Reports</p>
        ...
        <Card className="bg-gray-900 text-white border-0">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Dispatched Field Crew</p>
              <h3 className="text-3xl font-bold mt-1 text-emerald-400">0</h3>
            </div>
            <div className="w-10 h-10 rounded-xl bg-gray-800 text-emerald-400 flex items-center justify-center">
        ...
        <Card className="bg-gray-900 text-white border-0">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">AI Confidence Score Avg</p>
              <h3 className="text-3xl font-bold mt-1 text-amber-400">-- %</h3>
            </div>
            <div className="w-10 h-10 rounded-xl bg-gray-800 text-amber-400 flex items-center justify-center">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between border-b border-gray-100 pb-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Filter by severity, category, or status</p>
          </div>
        ...
        <CardContent className="py-12 text-center">
          <div className="max-w-xs mx-auto space-y-3">
            ...
            <h3 className="text-base font-semibold text-gray-800">Admin Queue Empty</h3>
